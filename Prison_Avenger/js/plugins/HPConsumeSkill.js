 ...
 */
 ...
 /*:ru
 * @plugindesc Возможность сделать навык, который затрачивает здоровье HP.
 * @author Sasuke KANNAZUKI
 *
 * @help Этот плагин не содержит никаких команд.
 *
 * Пишем в "Примечание" умения.
 *  <hp_cost:30>  - при использовании навык потратит 30 здоровья HP использующего.
 *
 *  Навык можно использовать, даже если у персонажа меньше здоровья, чем стоит навык.
 *  В таком случае, здоровье персонажа после использования будет равно 1.
 *  (т.е. нельзя умереть от использования навыка).
 */
