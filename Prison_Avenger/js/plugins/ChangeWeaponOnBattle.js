 ...
 */
 ...
 /*:ru
 * @plugindesc Оружие можно сменить прямо в бою.
 * @author Sasuke KANNAZUKI
 * 
 * @param commandName
 * @desc Имя команды в списке команд в бою.
 * @default Смена оружия
 *
 * @help Этот плагин не содержит никаких команд.
 * 
 * - Можно менять только оружие или щиты.
 * - Смена вооружения не тратит ход персонажа.
 * 
 */
