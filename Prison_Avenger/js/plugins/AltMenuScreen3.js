 ...
 */
 ...
 /*:ru
 * @plugindesc Альтернативное меню.
 * @author Sasuke KANNAZUKI, Yoji Ojima
 * 
 * @default 
 * @param bgBitmapMenu
 * @desc Изображения для фона меню (имя файла в папке pictures).
 * @default 
 * 
 * @param bgBitmapItem
 * @desc Изображения для фона в окне предметов (имя файла в папке pictures).
 * @default 
 * 
 * @param bgBitmapSkill
 * @desc Изображения для фона в окне навыков (имя файла в папке pictures).
 * @default 
 * 
 * @param bgBitmapEquip
 * @desc Изображения для фона в окне экипировки (имя файла в папке pictures).
 * @default 
 * 
 * @param bgBitmapStatus
 * @desc Изображения для фона в окне статуса (имя файла в папке pictures).
 * @default 
 * 
 * @param bgBitmapOptions
 * @desc Изображения для фона в окне опций (имя файла в папке pictures).
 * @default 
 * 
 * @param bgBitmapFile
 * @desc Изображения для фона в окне сохранить\загрузить (имя файла в папке pictures).
 * @default 
 * 
 * @param bgBitmapGameEnd
 * @desc Изображения для фона в окне завершения игры (имя файла в папке pictures).
 * @default 
 * 
 * @param maxColsMenu
 * @desc Сколько колонок с персонажами будет видно в меню
 * @default 4
 * 
 * @param commandRows
 * @desc Сколько строк с командами будет видно в меню
 * @default 2
 *
 * @param isDisplayStatus
 * @desc Показывать ли статус (здоровье, мана и т.д.) для персонажа. (1 = да, 0 = нет)
 * @default 0
 * 
 * @help Этот плагин не содержит никаких команд.
 *  Отличия от AltMenuscreen:
 *   - Фон меню прозрачный
 *   - Можно установить своё изображение на фон.
 *   - Можно установить своё изображение для персонажа (например в полный рост)
 *
 * Как установить своё изображение для персонажа:
 * <stand_picture:имя_картинки> - прописываем это в "Примечания" у персонажа в редакторе. 
 *   имя_картинки - имя изображение в папке picture
 *
 * Размеры для изображение персонажа:
 * ширина: 174px(maxColsMenu=4), 240px(maxColsMenu=3)
 * высота: 408px(commandRows=2), 444px(commandRows=1)
 */
