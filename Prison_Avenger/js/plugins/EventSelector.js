 ...
 */
 ...
 /*:ru
 * @plugindesc Окно вызова общих событий.
 * @author Yoji Ojima
 *
 * @help
 *
 * Команды: (В событии "Команда доп. модуля", 3 страница)
 *   EventSelector open       # Открыть окно 
 *   EventSelector add 3      # Добавить общее событие номер 3 в окно. 
 *	  - если затем в окне на него нажать, то оно выполнится.
 *   EventSelector remove 4   # Удалить общее событие номер 4 из окна.
 *   EventSelector clear      # Очистить окно.
 */
