 ...
 */
 ...
 /*:ru
 * @plugindesc Запрет смены построения для указанных персонажей.
 * @author Yoji Ojima
 *
 * @help
 *
 * Команды: (В событии "Команда доп. модуля", 3 страница)
 *   FixedBattleMembers 1       # Персонаж, который в группе первый, теперь заморожен на своём месте. 
 *	Т.е. нельзя сменить его позицию в меню "Построение".
 *   FixedBattleMembers 2 3     # Персонажи, которые в группе второй и третий, теперь будут первым и вторым
 * и будут заморожены.
 *   FixedBattleMembers         # Отменить все запреты.
 */
