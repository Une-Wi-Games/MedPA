 ...
 */
 ...
 /*:
 * @plugindesc Книга противников - подробное описание противников.
 * @author Yoji Ojima
 *
 * @param Unknown Data
 * @desc Так будут показаны ещё не открытые противники.
 * @default ??????
 *
 * @help 
 * В книгу изначально добавляются все противники из базы. 
 * Команды: (В событии "Команда доп. модуля", 3 страница)
 *   EnemyBook open         # Открыть книгу.
 *   EnemyBook add 3        # Открыть врага номер 3 в книге (т.е. можно посмотреть его данные).
 *   EnemyBook remove 4     # Закрыть врага номер 4 в книге.
 *   EnemyBook complete     # Открыть информацию о всех противниках.
 *   EnemyBook clear        # Закрыть информацию о всех противниках.
 *
 * Дополнительно в "Примечания" противника.
 *   <desc1:текст>         # Описание врага, 1 строчка.
 *   <desc2:текст>       # Описание врага, 2 строчка.
 *   <book:no>              # Этот противник не появится в книге.
 */
