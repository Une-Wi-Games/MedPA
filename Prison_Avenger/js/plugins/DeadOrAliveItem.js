 ...
 */
 ...
 /*:ru
 * @plugindesc Можно использовать предмет или умение как на мёртвой, так и на живой цели.
 * @author Sasuke KANNAZUKI
 * 
 * @help Этот плагин не содержит никаких команд.
 * 
 * Прописываем это в "Примечания" для предмета или уменя.
 *   <scope:oneDeadOrAlive> - если только на одну цель (мёртвую или живую)
 *   <scope:allDeadOrAlive> - если на все сразу (мёртвые или живые)
 * Пример:
 *  - навык, который воскрешает мёртвого и полным здоровьем (HP), а если 
 * использовать его на живом, то восстанавливает здоровье до максимума.
 */
