 ...
 */
 ...
 /*:ru
 * @plugindesc Сообщения выводятся в полный экран
 * @author Yoji Ojima, Sasuke KANNAZUKI
 *
 * @param Switch ID
 * @desc Номер оператора, который отвечает включён ли этот режим или нет.
 * (Управляющие операторы)
 * @default 11
 *
 * @help
 * Текст будет появлятся в самом вверху и дописываться каждый раз ниже.
 * Используйте символ '\F' в тексте, чтобы стереть предыдущий текст.
 *
 * Этот плагин не содержит никаких команд.
 */
