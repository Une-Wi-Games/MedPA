 ...
 */
 /*:
 * @plugindesc Вопроизведение звуков (SE) при действиях во время битвы 
 * @author Sasuke KANNAZUKI
 * 
 * @param pitch
 * @desc Скорость звука. Действует на все.
 * @default 100
 *
 * @param volume
 * @desc Громкость звука. Действует на все.
 * @default 90
 * 
 * @help Этот плагин не содержит никаких команд.
 * 
 * Прописываем команды в "Примечания" для персонажа:
 * можно только некоторые
 * имя_файла - имя звукового файла в папке audio\se
 * <attackVoice:имя_файла>  звук обычной атаки персонажа.
 * <recoverVoice:имя_файла>   звук, когда персонаж восстанавливает здоровье HP.
 * <friendMagicVoice:имя_файла> звук, когда персонаж применяет магию на союзнике
 *  кроме восстановления здоровья HP. Если этот параметр не задан, но <skillVoice:имя_файла> задан,
 *   будет воспроизведён <magicVoice:имя_файла>.
 * <magicVoice:имя_файла>   звук, когда персонаж использует магию (кроме магии на союзника, см. выше)
 * <skillVoice:имя_файла>   звук, когда персонаж использует специальный навык (не магию).
 * <damageVoice:имя_файла>    звук, когда персонаж получает урон. (Бьют его короче :))
 * <defeatedVoice:имя_файла>   звук, когда персонаж умирает.
 * <victoryVoice:имя_файла>   звук при победе. 
 *  Если сразу у многих персонажей заданы звуки, то выбирается случайный.
 *
 */
