 ...
 */
 ...
 /*:ru
 * @plugindesc Упрощённый лог битвы в режиме вид сбоку.
 * @author Sasuke KANNAZUKI
 *
 * @param displayAttack
 * @desc Отображать сообщения об атаке. 1:да 0:нет
 * @default 0
 *
 * @param position
 * @desc Позиция сообщений о навыках. 0:слево, 1:в центре
 * @default 1
 *
 * @help Этот плагин не содержит никаких команд.
 *
 * С этим плагином скорость битвы возрастает, так как не тратится время на 
 * отображение сообщений битвы.
 */
